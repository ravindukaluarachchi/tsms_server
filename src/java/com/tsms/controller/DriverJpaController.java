...
import com.tsms.controller.exceptions.PreexistingEntityException;
...
public class DriverJpaController implements Serializable {
    ...
    public void create(Driver driver) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findDriver(driver.getNic()) != null) {
                throw new PreexistingEntityException("Driver " + driver + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
